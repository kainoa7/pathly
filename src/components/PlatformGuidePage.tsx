        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-[#71ADBA] max-w-2xl mx-auto">
              Discover how Pathly helps you navigate your career journey with personalized guidance and support 🚀
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-b from-transparent to-[#1a2234]">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-[#71ADBA] mb-8">Join thousands of students who found their dream career with Pathly</p>
            <motion.button
