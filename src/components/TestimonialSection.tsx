  ...
  const testimonials = [
    {
      ...
      content: "No CS degree? Same! Used PathFinder to break into tech. Now making 6 figures at Google! 🚀",
      tag: "Career Changer",
      icon: WorkIcon,
    ...
    },
    {
      ...
      content: "Was stuck between 5 majors 😩 PathFinder helped me choose CS. Now interning at Tesla! ⚡",
      tag: "College Student",
      icon: SchoolIcon,
    ...
    },
    {
      ...
      content: "From confused about college to launching my own startup! PathFinder showed me the entrepreneurship path 💡",
      tag: "Entrepreneur",
      icon: TrendingUpIcon,
      stats: "Raised $1M",
    }
