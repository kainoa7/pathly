...
const SignupExplorer = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      console.log('Attempting to create account with data:', formData);
      
      const requestData = {
        ...formData,
        accountType: 'EXPLORER', // Set account type to EXPLORER
        university: '', // Explorer doesn't have university field, so set empty
        graduationYear: '' // Explorer doesn't have graduation year, so set empty
      };
      ...
      >
        ...
        <div className="bg-dark-backgroundSecondary rounded-2xl p-8 shadow-xl border border-dark-border">
          ...
          <button
            ...
            className="w-full py-3 px-4 rounded-lg border border-dark-border bg-dark-background text-white hover:bg-dark-border transition-colors flex items-center justify-center gap-3 mb-6"
          >
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-dark-backgroundSecondary text-gray-400">or continue with email</span>
            </div>
          </div>
