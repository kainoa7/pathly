      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-[#71ADBA] via-[#9C71BA] to-[#EDEAB1] bg-clip-text text-transparent">
            Help Shape K<span className="text-[#71ADBA]">ai</span>yl's Future
          </h1>
        ...
        >
          ...
          <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
                          Have a suggestion for how we can make K<span className="text-[#71ADBA]">ai</span>yl better? We'd love to hear it! Click the button below to share your feedback.
          </p>
          <motion.button
