...
const stories: Story[] = [
  {
    ...
    tag: "Career Changer 🔥",
          story: "No CS degree? Same! Used Jarvus to break into tech. Now making 6 figures at Google! 🚀",
  ...
  },
  {
    ...
    tag: "Major Switcher ⚡",
          story: "Switched from Biology to Tech PM. Jarvus helped me find my true passion. Now leading product teams! 💪",
  ...
  },
  {
    ...
    tag: "Fast Tracker 🎯",
          story: "From confused about career to data scientist at Tesla in 6 months. Jarvus's roadmap made it possible! 📈",
