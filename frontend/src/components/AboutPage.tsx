        ...
        >
          ...
          <div className="text-center max-w-4xl mx-auto">
            <p className="text-xl text-gray-300 mb-6 leading-relaxed">
              Pathly exists for one simple reason: to be your trusted guide when you're feeling uncertain about your future. We understand the overwhelming pressure of making life-changing decisions about your education and career.
            </p>
