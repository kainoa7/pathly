        ...
        >
          ...
          <div className="space-y-8 text-gray-300">
            <section>
              ...
              <p className="mb-6">
                Join us in nurturing the next generation of leaders. At K<span className="text-[#71ADBA]">ai</span>yl, we believe in 
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-white">The K<span className="text-[#71ADBA]">ai</span>yl Advantage</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-[#0f172a] p-6 rounded-lg">
                  <div className="flex items-center gap-3 mb-3">
